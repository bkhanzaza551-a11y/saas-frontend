...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Manage Enquiries", description: "View and respond to customer enquiries.", to: "/admin/enquiries", icon: MessagesSquare, reqPerm: "enquiries", reqFlag: "enquiries" }
    ]
  },
  {
    ...
    items: [
      ...
      { title: "Business Trends", description: "View overall business growth and sales trends.", to: "/admin/trends", icon: TrendingUp, reqPerm: "reports", reqFlag: "reports" }
    ]
  },
  {
    title: "System & Setup",
    items: [
      { title: "Platform Settings", description: "Configure global system preferences and defaults.", to: "/admin/settings/generic", icon: Settings, reqPerm: "settings" },
      { title: "Salon Details", description: "Manage business information, tax details, and branding.", to: "/admin/salon-details", icon: Store, reqPerm: "settings" }
    ]
  }
];
