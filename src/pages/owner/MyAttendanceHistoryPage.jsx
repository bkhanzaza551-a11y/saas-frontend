...
const statusColor = (status) => {
  switch (status) {
    case "NOT_CHECKED_IN": return { bg: "rgba(100,116,139,0.12)", text: "#475569", border: "rgba(100,116,139,0.25)" };
    ...
    case "CHECKED_OUT": return { bg: "rgba(59,130,246,0.12)", text: "#1e40af", border: "rgba(59,130,246,0.25)" };
...
export default function MyAttendanceHistoryPage() {
  ...
  const stats = useMemo(() => {
    ...
    const present = filteredRecords.filter((r) => r.status === "PRESENT" || r.status === "CHECKED_OUT").length;
