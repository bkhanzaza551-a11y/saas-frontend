...
export default function CustomersPage() {
  ...
  const downloadTestData = () => {
    ...
    const headers = "MOBILE NO,NAME,GENDER,LAST VISITED,TOTAL ORDERS,TOTAL PURCHASE AMOUNT,AVERAGE PURCHASE AMOUNT,ONLINE VISITS,LOYALTY,REFERRAL CODE,ADVANCE,BALANCE,MEMBERSHIP COUNT,PACKAGE COUNT,BIRTH DATE\n";
        ...
        <div className="modal-overlay" onClick={() => { setShowFamilyModal(false); setFamilyError(""); setSelectedFamilyGuest(null); setFamilySearchQuery(""); setFamilySearchResults([]); }}>
          <div className="modal-content" style={{ width: "min(90vw, 440px)" }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              ...
              <button className="crm-btn" onClick={handleAddFamilyMember}>+ Add Customer</button>
            </div>
          </div>
        </div>
      )}
