...
export default function CustomersPage() {
  ...
  const downloadTestData = () => {
    ...
    const headers = "MOBILE NO (Mandatory),NAME (Mandatory),GENDER (Mandatory),LAST VISITED (Optional),TOTAL ORDERS (Optional),TOTAL PURCHASE AMOUNT (Optional),AVERAGE PURCHASE AMOUNT (Optional),ONLINE VISITS (Optional),LOYALTY (Optional),REFERRAL CODE (Optional),ADVANCE (Optional),BALANCE (Optional),MEMBERSHIP COUNT (Optional),PACKAGE COUNT (Optional),BIRTH DATE (Optional)\n";
    const rows = `92374080383,Ali Khan,Female,14-Sept-2026,1,742,742,2,169,ALI7970,500,200,1,1,10-Aug-1990\n92398755722,Sara Ahmed,Male,14-Sept-2026,10,10700,1070,0,26,SARA1986,0,0,0,0,11-Aug-1991\n92328755068,John Smith,Male,14-Sept-2026,2,1782,891,2,112,JOHN5256,0,0,0,0,12-Aug-1992\n92379542225,Aisha Ali,Female,14-Sept-2026,3,1785,595,2,0,AISHA9745,0,0,0,0,13-Aug-1993\n92330281928,Omar Hussain,Male,14-Sept-2026,1,631,631,0,92,OMAR9543,500,0,0,0,14-Aug-1994\n92315891843,Zainab Raza,Male,14-Sept-2026,3,2829,943,0,33,ZAINAB6628,0,200,0,0,15-Aug-1995\n92373796580,Bilal Malik,Female,14-Sept-2026,4,5944,1486,2,190,BILAL1157,0,0,1,0,16-Aug-1996\n92316246627,Fatima Shah,Male,14-Sept-2026,1,989,989,1,71,FATIMA7550,0,0,0,1,17-Aug-1997\n92350067917,Hassan Iqbal,Male,14-Sept-2026,4,4792,1198,2,175,HASSAN7273,500,0,0,0,18-Aug-1998\n92352948916,Maryam Javed,Female,14-Sept-2026,2,2172,1086,2,32,MARYAM3535,0,0,0,0,19-Aug-1999\n92340944368,Usman Tariq,Male,14-Sept-2026,6,7332,1222,1,107,USMAN8923,0,200,0,0,20-Aug-1990\n92397772463,Khadija Qureshi,Male,14-Sept-2026,3,2250,750,2,190,KHADIJA2172,0,0,0,0,21-Aug-1991\n92366001104,Tariq Baig,Female,14-Sept-2026,6,5262,877,1,178,TARIQ9140,500,0,1,0,22-Aug-1992\n92343711573,Amina Sheikh,Male,14-Sept-2026,5,4225,845,0,23,AMINA1479,0,0,0,0,23-Aug-1993\n92340627643,Raza Mirza,Male,14-Sept-2026,6,8862,1477,0,60,RAZA8650,0,0,0,1,24-Aug-1994\n92350269075,Sana Khan,Female,14-Sept-2026,5,4735,947,0,98,SANA5469,0,200,0,0,25-Aug-1995\n92329807676,Ibrahim Ahmed,Male,14-Sept-2026,10,7460,746,2,12,IBRAHIM8284,500,0,0,0,26-Aug-1996\n92358594452,Hira Smith,Male,14-Sept-2026,10,9320,932,1,188,HIRA4017,0,0,0,0,27-Aug-1997\n92355747179,Kamran Ali,Female,14-Sept-2026,9,13302,1478,1,88,KAMRAN5235,0,0,1,0,28-Aug-1998\n92316918941,Nida Hussain,Male,14-Sept-2026,1,1201,1201,2,155,NIDA1904,0,0,0,0,29-Aug-1999\n92330292304,Fahad Raza,Male,14-Sept-2026,7,6979,997,2,21,FAHAD5372,500,200,0,0,10-Aug-1990\n92320032700,Zoya Malik,Female,14-Sept-2026,1,1184,1184,2,13,ZOYA6606,0,0,0,1,11-Aug-1991\n92394424948,Hamza Shah,Male,14-Sept-2026,10,5340,534,0,93,HAMZA3061,0,0,0,0,12-Aug-1992\n92397146866,Sadia Iqbal,Male,14-Sept-2026,3,3756,1252,2,162,SADIA2178,0,0,0,0,13-Aug-1993\n92380291752,Imran Javed,Female,14-Sept-2026,7,9786,1398,1,64,IMRAN7492,500,0,1,0,14-Aug-1994\n`;
          ...
          <>
            ...
            <div className="form-group">
              ...
              <div className="radio-column">
                ...
                <label><input type="radio" name="visitType" checked={draftFilters.visitType === "new"} onChange={() => setDraftFilters((current) => ({ ...current, visitType: "new" }))} /> New Customer</label>
                <label><input type="radio" name="visitType" checked={draftFilters.visitType === "repeat"} onChange={() => setDraftFilters((current) => ({ ...current, visitType: "repeat" }))} /> Repetitive Customer</label>
              </div>
            </div>
          </>
        );
        ...
        return (
          <div className="form-group">
            ...
            <CustomSelect value={draftFilters.clientRetention} onChange={(event) => setDraftFilters((current) => ({ ...current, clientRetention: event.target.value }))}>
              ...
              <option value="repeat">Repetitive Customer</option>
            </CustomSelect>
          </div>
        );
    ...
    <div style={{ padding: "10px 16px", background: "#f8fafc", minHeight: "100%", width: "100%" }}>
      <style>
        {`
          ...
          .cust-detail-sidebar { width:35%; background:#f8fafc; border-right:1px solid #e2e8f0; color:#fff; display:flex; flex-direction:column; overflow-y:auto; flex-shrink:0; }
          .cust-detail-sidebar::-webkit-scrollbar { width:4px; }
          .cust-detail-sidebar::-webkit-scrollbar-thumb { background:#cbd5e1; border-radius:4px; }
          .cust-detail-sidebar-info { padding:20px 16px; border-bottom:1px solid #e2e8f0; }
          ...
          .cust-detail-edit-btn { background:#fff; border:1px solid #cbd5e1; color:#64748b; border-radius:6px; padding:5px; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .15s; margin-left:auto; flex-shrink:0; }
          .cust-detail-edit-btn:hover { background:#f1f5f9; color:#0f172a; }
          ...
          .cust-detail-close-mobile { display:none; background:#fff !important; border:1px solid #cbd5e1 !important; color:#64748b !important; border-radius:8px !important; width:34px !important; height:34px !important; min-width:34px !important; min-height:34px !important; align-items:center !important; justify-content:center !important; cursor:pointer !important; margin-left:6px !important; flex-shrink:0 !important; padding:0 !important; box-shadow:none !important; transition:all .15s !important; }
          .cust-detail-close-mobile:hover { background:#fee2e2 !important; border-color:#fca5a5 !important; color:#dc2626 !important; }
          .cust-detail-edit-btn-mobile { background:#fff !important; border:1px solid #cbd5e1 !important; color:#64748b !important; border-radius:8px !important; width:34px !important; height:34px !important; min-width:34px !important; min-height:34px !important; padding:0 !important; cursor:pointer !important; display:flex !important; align-items:center !important; justify-content:center !important; transition:all .15s !important; margin-left:auto !important; flex-shrink:0 !important; box-shadow:none !important; }
          .cust-detail-edit-btn-mobile:hover { background:#f1f5f9 !important; color:#0f172a !important; }
          ...
          @media (max-width: 900px) {
            ...
            .cust-detail-sidebar { width:100% !important; height:auto !important; flex-shrink:0 !important; overflow:visible !important; background:#f8fafc !important; border-bottom:1px solid #e2e8f0 !important; }
            .cust-detail-sidebar-info { padding:12px 16px !important; border-bottom:none !important; }
            .cust-detail-sidebar-info-header { margin-bottom:0 !important; }
            .cust-detail-sidebar-fields { display:none !important; }
            .cust-detail-sidebar-nav { position:sticky !important; top:0 !important; z-index:50 !important; display:flex !important; flex-direction:row !important; overflow-x:auto !important; white-space:nowrap !important; padding:8px 12px !important; background:#f8fafc !important; border-top:1px solid #e2e8f0 !important; border-bottom:1px solid #e2e8f0 !important; gap:8px !important; -webkit-overflow-scrolling:touch !important; scrollbar-width:none !important; }
            .cust-detail-sidebar-nav::-webkit-scrollbar { display:none !important; }
            .cust-detail-nav-btn { width:auto !important; flex-shrink:0 !important; padding:6px 14px !important; font-size:0.8rem !important; border-radius:20px !important; background:#f1f5f9 !important; color:#64748b !important; white-space:nowrap !important; display:inline-flex !important; align-items:center !important; gap:6px !important; border:1px solid #e2e8f0 !important; }
            ...
            .cust-detail-content { flex:1 0 auto !important; overflow:visible !important; width:100% !important; background:#ffffff !important; }
            .cust-detail-content-header { display:none !important; }
          ...
          <div className="sidebar-modal" onClick={(event) => event.stopPropagation()}>
            ...
            <form onSubmit={handleAddGuest} style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
              ...
              <div className="sidebar-modal-footer" style={{ borderTop: "1px solid #e2e8f0", padding: "16px 24px", justifyContent: "flex-end", gap: "12px", background: "white" }}>
                ...
                <button type="submit" className="crm-btn" style={{ padding: "10px 24px" }}>Add Customer</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="modal-content" style={{ width: "min(95vw, 420px)", borderRadius: 20, padding: 0, overflow: "hidden", background: "#fff", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.4)", display: "flex", flexDirection: "column", animation: "modalPop 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)" }} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: "30px 24px" }}>
              ...
              <button
                ...
                disabled={isSendingOtp || isVerifyingOtp || otpValue.length !== 6}
              >
