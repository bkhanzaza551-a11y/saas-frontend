          ...
          {status.loading ? (
            ...
            <div>
              <button
                ...
                style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "6px 14px", background: "#f1f5f9", border: "1px solid #e2e8f0", borderRadius: 8, fontSize: 13, fontWeight: 600, color: "#475569", cursor: "pointer", marginBottom: 16, transition: "all 0.2s" }}
              ...
              {selectedTicket.assignedAgentName && (
                <div style={{ fontSize: 12, color: "#475569", marginBottom: 14, background: "#eef2ff", padding: "8px 12px", borderRadius: 8, display: "inline-block" }}>
              ...
              {selectedTicket.messages && selectedTicket.messages.length > 0 && (
                <div style={{ marginTop: 16, marginBottom: 16 }}>
                  <h5 style={{ margin: "0 0 12px", fontSize: 11, fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: 0.8 }}>
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 4 }}>
                            <strong style={{ fontSize: 12, color: isOwnerAuthor ? "#3730a3" : "#0f172a" }}>
                              {msg.authorName || (isOwnerAuthor ? "You" : "Support Agent")}
                              <span style={{ fontWeight: 400, fontSize: 10, color: "#64748b", marginLeft: 4 }}>({msg.authorType})</span>
                            </strong>
