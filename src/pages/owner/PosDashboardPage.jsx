                      ...
                      return (
                        <div key={item.id || `${item.serviceId || item.productId || "item"}-${index}`} className="cart-table-row" style={{ gridTemplateColumns: "2fr 2fr 1fr 1fr 1.5fr 1fr 1fr 1fr 1.5fr 2fr" }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                            <button type="button" title="Split Service" onClick={() => setStatus({ error: "", success: "Split service workflow is reserved for the next pass." })} style={{ background: "transparent", border: "none", cursor: "pointer", color: "var(--accent, #3b82f6)", padding: 4, minHeight: 0 }} disabled={!isEditing}><ScissorsLineDashed size={16} /></button>
                            <button type="button" title="Service Reminder" onClick={() => openReminderModal(index)} style={{ background: "transparent", border: "none", cursor: "pointer", color: item.serviceReminder?.date ? "#16a34a" : "#111827", padding: 4, minHeight: 0 }} disabled={!isEditing}><Clock3 size={16} /></button>
                            ...
                            }} style={{ background: "transparent", border: "none", cursor: "pointer", color: item.complimentary ? "#16a34a" : "#3b82f6", padding: 4, minHeight: 0 }} disabled={!isEditing}><Gift size={16} /></button>
                            <button type="button" title="Add Consumable Items For Service" onClick={() => openConsumableModal(index)} style={{ background: "transparent", border: "none", cursor: "pointer", color: item.consumables?.length ? "#16a34a" : "#3b82f6", padding: 4, minHeight: 0 }} disabled={!isEditing}><TicketPercent size={16} /></button>
                            {isEditing ? <button type="button" title="Remove Item" onClick={() => removeItem(index)} style={{ background: "transparent", border: "none", cursor: "pointer", color: "#ef4444", padding: 4, minHeight: 0 }}><Trash2 size={16} /></button> : null}
                          </div>
                        </div>
                      );
                    })}
