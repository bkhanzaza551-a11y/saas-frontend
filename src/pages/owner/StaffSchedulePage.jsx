      ...
      <div className="three-col">
        <div className="panel-card">
          ...
          <form onSubmit={async (event) => {
            ...
            <CustomSelect value={scheduleForm.userSalonId} onChange={(event) => setScheduleForm((current) => ({ ...current, userSalonId: event.target.value }))}>
        ...
        <div className="panel-card">
          ...
          <form onSubmit={async (event) => {
            ...
            <CustomSelect value={breakForm.userSalonId} onChange={(event) => setBreakForm((current) => ({ ...current, userSalonId: event.target.value }))}>
              <option value="">Select staff</option>
              {staff.map((item) => <option key={item.id} value={item.id}>{item.user?.name}</option>)}
            </CustomSelect>
