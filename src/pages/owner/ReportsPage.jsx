...
export default function ReportsPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      const requests = {
        sales: api.get("/owner/reports/sales-summary", { params: sharedParams }),
        payments: api.get("/owner/reports/payment-modes", { params: sharedParams }),
        appointments: api.get("/owner/reports/appointments", { params: sharedParams }),
        staff: api.get("/owner/reports/staff-performance", { params: sharedParams }),
        products: api.get("/owner/reports/product-sales", { params: sharedParams }),
        services: api.get("/owner/reports/service-sales", { params: sharedParams }),
        memberships: api.get("/owner/reports/memberships", { params: sharedParams }),
        packages: api.get("/owner/reports/packages", { params: sharedParams }),
        stock: api.get("/owner/reports/stock", { params: sharedParams }),
        customers: api.get("/owner/reports/customers", { params: sharedParams }),
        branchSales: api.get("/owner/reports/branch-sales", { params: sharedParams }),
        cancelled: api.get("/owner/reports/cancelled-invoices", { params: sharedParams }),
        lowStock: api.get("/owner/reports/low-stock", { params: sharedParams }),
