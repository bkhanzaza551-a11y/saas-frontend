              ...
              <div key={req.id} className="panel-card" style={{ padding: 20, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                ...
                <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: 14, marginTop: 10, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    {req.status === "PENDING" && (
                      <button onClick={() => updateStatus(req.id, "APPROVED")} className="btn btn-secondary" style={{ padding: "4px 8px", fontSize: 12, color: "#16a34a" }} title="Approve">
                        <CheckCircle2 size={14} />
                      </button>
                    )}
                    {req.status === "APPROVED" && (
                      <button onClick={() => updateStatus(req.id, "FULFILLED")} className="btn btn-secondary" style={{ padding: "4px 8px", fontSize: 12, color: "#2563eb" }} title="Mark Fulfilled">
                        <UserCheck size={14} />
                      </button>
                    )}
